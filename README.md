...
**VisualSource (VS)** is a node-based visual scripting language built for RetroStudio — a Roblox game development environment that simulates the Roblox client from **2009 to mid-2015**, and runs scripts at **runtime** inside the simulation. Instead of writing code, you connect visual **Blocks** together to build game logic, which is then compiled to Luau automatically.
...
7. [**Block Deep Dives**](blocks/CloneObject.md) — Detailed documentation for individual blocks
